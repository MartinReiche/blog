...
<Gallery
    ...
    imageProps={[
        {title: "Schwarzwald im Winter", rows: 2, cols: 4},
        {title: "Schweinehunde!", rows: 1, cols: 2},
        {title: "Berge, Berge, Kindersärge", rows: 1, cols: 2},
        {title: "Treppen!", rows: 2, cols: 3},
        {title: "Gute Nacht", rows: 2, cols: 3},
    ]}
    options={{cols:6}}
/>
