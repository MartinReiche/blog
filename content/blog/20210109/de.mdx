...
<StepperGallery
    images={[
        {src: props.galleryImages[0], title: "Schwarzwald im Winter", rows: 2, cols: 4},
        {src: props.galleryImages[1], title: "Schweinehunde!", rows: 1, cols: 2},
        {src: props.galleryImages[2], title: "Berge, Berge, Kindersärge", rows: 1, cols: 2},
        {src: props.galleryImages[3], title: "Treppen!", rows: 2, cols: 3},
    ]}
/>
