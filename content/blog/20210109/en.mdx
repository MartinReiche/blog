...
<CombinedGallery
    images={[
        {src: props.galleryImages[0], title: "Black Forest in Winter", rows: 2, cols: 4},
        {src: props.galleryImages[1], title: "Pigs! Dogs!", rows: 1, cols: 2},
        {src: props.galleryImages[2], title: "Mountains", rows: 1, cols: 2},
        {src: props.galleryImages[3], title: "Stairs!", rows: 2, cols: 3},
        {src: props.galleryImages[4], title: "Good Night!", rows: 2, cols: 3},
    ]}
    options={{cols:6}}
/>
